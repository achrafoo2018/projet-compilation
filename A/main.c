...
// Retourne vrai si le character est un délimteur
...
// Retourne vrai si le character est un opérateur
...
// Retourne vrai si le character est un mot-clé
...
// Retourne vrai si le character est un réel
